...
class IBVS_plug_hole(Node):
    ...
    def computeDesiredInteractionMat(self):
        ...
        for point in self.desiredHoles:
            tempLst.append(
    ...
    def computeCamVel(self):
        ...
        self.pixelVel = np.array(tempLst).reshape(((5 * 2), 1))     # column vector
    ...
    def computeEEVel(self):
        ...
        if (self.curHoles is not None and len(self.curHoles) == 5):
